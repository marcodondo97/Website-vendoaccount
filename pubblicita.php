...
$all_rows = mysql_num_rows(mysql_query("SELECT codicea FROM annunci WHERE categoria='pubblicita'"));
$all_pages = ceil($all_rows / $x_pag);
$first = ($pag - 1) * $x_pag;
$query34 = "SELECT * FROM annunci WHERE categoria='pubblicita'  order by dataa DESC LIMIT $first, $x_pag  ";
...
<head>
    <title>Spazi per pubblicità su internet </title>
    <meta charset="UTF-8" />
    <meta name="author" content="Marco Dondo" />
    <meta name="description" content="Spazi su siti web per pubblicizzarti" />
    <meta name="keywords" content="banner, come togliere la pubblicità, advertising, bloccare, blog, social, affiliate marketing" />
...
<h3 style=' color:white; padding-top:12px; font-family: Viga, sans-serif ; '>  Spazi pubblicitari in vendita sul web <h3>
</div>";}
else{}
?>
    <br><br>
