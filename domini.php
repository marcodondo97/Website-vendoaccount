...
$all_rows = mysql_num_rows(mysql_query("SELECT codicea FROM annunci WHERE categoria='dominio'"));
$all_pages = ceil($all_rows / $x_pag);
$first = ($pag - 1) * $x_pag;
$query34 = "SELECT * FROM annunci WHERE categoria='dominio'  order by dataa DESC LIMIT $first, $x_pag  ";
...
<head>
    <title>Domini e siti web in vendita</title>
    <meta charset="UTF-8" />
    <meta name="author" content="Marco Dondo" />
    <meta name="description" content="Cerca e vendi domini e siti web già attivi da poter comprare e riutilizzare  " />
    <meta name="keywords" content="dominio, pagamento, guadagni" />
...
<h3  style=' color:white; padding-top:12px; font-family: Viga, sans-serif ; '>  Siti web, blog e domini in vendita <h3>
</div>";}
else{}
?>
    <br><br>
