...
$all_rows = mysql_num_rows(mysql_query("SELECT codicea FROM annunci WHERE categoria='profili-social'"));
$all_pages = ceil($all_rows / $x_pag);
$first = ($pag - 1) * $x_pag;
$query34 = "SELECT * FROM annunci WHERE categoria='profili-social'  order by dataa DESC LIMIT $first, $x_pag  ";
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="padding-top:4px;"><img src="img/logobianco.png" style="width:180px;" alt="follower" /></a>
...
<h3 style=' color:white; padding-top:12px; font-family: Viga, sans-serif '>  Account social e followers  <h3>
</div>";}
else{}
?>
    <br><br>
...
$ciao= mysql_result($risultati, $i, "codicea");
 ...
 echo " <div class='container' style='background-color:white; '> <h3 style='background-color:white; '> <h3 style='font-family: Lato, sans-serif; font-size:1.9rem;'><b>".$titolo." </b><div style='float:right;'>";
