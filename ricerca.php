...
$all_rows = mysql_num_rows(mysql_query("SELECT codicea FROM annunci WHERE contenuto  LIKE '%".$campo ."%' or titolo  LIKE '%".$campo ."%' "));
$all_pages = ceil($all_rows / $x_pag);
$first = ($pag - 1) * $x_pag;
$query34 = "SELECT * FROM annunci  WHERE contenuto  LIKE '%".$campo ."%' or titolo  LIKE '%".$campo ."%'  order by dataa DESC LIMIT $first, $x_pag  ";
...
<head>
    <title>Fai la tua ricerca su vendoaccount</title>
    <meta name="description" content="Fai la tua ricerca tra account social e game , spazi pubblicitari, articoli per web" />
    <meta name="keywords" content="legue of legend,redazione sito " />
...
<h3 style=' color:white; padding-top:12px; font-family: Viga, sans-serif; '>  I risultati per: ".$campo." <h3>
</div>";}
else{}
?>
    <br><br>
