...
$first = ($pag - 1) * $x_pag;
$query34 = "SELECT * FROM annunci order by dataa DESC LIMIT $first, $x_pag  ";
...
<html lang="it">
<head>
  <title>Tutti gli annunci disponibili</title>
  <meta name="description" content="Tutti gli annunci del sito disponibili per te"/>
  <meta name="keywords" content="recensioni, temi vari, cronaca, graris, pagamento, lingue, riviste"/>
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php"style="padding-top:4px;"><img src="img/logobianco.png" style="width:180px;" alt="combat" /></a>
  ...
  <ul class='dropdown-menu' role='menu' aria-labelledby='dropdownMenu1' style='background-color:#222222;'>
      <form action='domini.php' method='GET' ><li role='presentation'><button class='btn-link'role='menuitem' tabindex='1' style='font-size:18px; font-family: Staatliches, cursive;'  onclick=''>  Domini </button> </li> </form> <br>
	
	<form action='articoli.php' method='GET' ><li role='presentation'><button class='btn-link'role='menuitem' tabindex='1' style='font-size:18px; font-family: Staatliches, cursive;'  onclick=''>  Articoli </button></li> </form><br>

	<form action='profili-game.php' method='GET' ><li role='presentation'><button class='btn-link'role='menuitem' tabindex='1' style='font-size:18px; font-family: Staatliches, cursive;' onclick=''>  Profili-game </button> </li></form><br>
	
	<form action='profili-social.php' method='GET' ><li role='presentation'><button class='btn-link'role='menuitem' tabindex='1'style='font-size:18px; font-family: Staatliches, cursive;'  onclick=''>  Profili-social </button> </li></form><br>

	<form action='pubblicita.php' method='GET' ><li role='presentation'><button class='btn-link'role='menuitem' tabindex='1'style='font-size:18px; font-family: Staatliches, cursive;' onclick=''>  Pubblicita' </button></li> </form><br>
	
	<form action='altro.php' method='GET' ><li role='presentation'><button class='btn-link'role='menuitem' tabindex='1'style='font-size:18px; font-family: Staatliches, cursive;'  onclick=''>  Altro </button> </li></form><br>
...
<h3 style=' color:white; padding-top:12px; font-family: Viga, sans-serif '>  Tutti gli annunci del sito disponibili per te  <h3>
</div>";}
else{}
?>
<br><br>
