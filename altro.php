...
$all_rows = mysql_num_rows(mysql_query("SELECT codicea FROM annunci WHERE categoria='altro'"));
$all_pages = ceil($all_rows / $x_pag);
$first = ($pag - 1) * $x_pag;
$query34 = "SELECT * FROM annunci WHERE categoria='altro' order by dataa DESC LIMIT $first, $x_pag  ";
...
<head>
    <title> Fuori categoria</title>
    <!--meta tags -->
    <meta charset="UTF-8" />
    <meta name="author" content="Marco Dondo" />
    <meta name="description" content="Tutte le inserzioni di prodotti digitali fuori categoria sono disponibile per te" />
    <meta name="keywords" content="digitale, script, grafiche, photoshop, app, bot, assistenza" />
...
<h3 style=' color:white; padding-top:12px; font-family: Viga, sans-serif ; '>  Annunci fuori categoria disponibili per te <h3>
</div>";}
else{}
?>
    <br><br>

    <!-- estrazione dal database degli annunci  -->
    <?php	
