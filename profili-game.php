...
$all_rows = mysql_num_rows(mysql_query("SELECT codicea FROM annunci WHERE categoria='profili-game'"));
$all_pages = ceil($all_rows / $x_pag);
$first = ($pag - 1) * $x_pag;
$query34 = "SELECT * FROM annunci WHERE categoria='profili-game'  order by dataa DESC LIMIT $first, $x_pag  ";
...
<head>
    <title>Profili games</title>
    <meta charset="UTF-8" />
    <meta name="author" content="Marco Dondo" />
    <meta name="description" content="Cerca o inserisci il tuo annunci per vendere i tuoi profili videogiochi e account di console. " />
    <meta name="keywords" content="lol, clash royale, ps4, playstation network, sky, dazn, steam, online, combat arms." />
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="padding-top:4px;"><img src="img/logobianco.png" style="width:180px;" alt="ps4" /></a>
                    ...
                    <li class='dropdown'>
                        ...
                        <ul class='dropdown-menu' role='menu' aria-labelledby='dropdownMenu1' style='background-color:#222222;'>
                            ...
                            <form action='articoli.php' method='GET'>
                                <li role='presentation'><button class='btn-link' role='menuitem' tabindex='1' style='font-size:18px; font-family: Staatliches, cursive;' onclick=''> Articoli </button> </li>
                            </form>
                            <br>
...
<h3 style=' color:white; padding-top:12px; font-family: Viga, sans-serif ; '> Annunci di account games in vendita <h3>
</div>";}
else{
